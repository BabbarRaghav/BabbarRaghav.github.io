...
const Project = () => {
  const [Work] = useState([
    ...
    {
      img: "https://images.pexels.com/photos/3184188/pexels-photo-3184188.jpeg",
      title: "LunchLauncher",
  ...
  return (
    <div className="main flex flex-col justify-center items-center lg:items-stretch mt-9 space-y-4 lg:space-y-0 text-center lg:grid lg:gap-4 lg:grid-cols-4 lg:grid-rows-4 mx-3">
      {Work.map((work) => {
        return (
          <div
            className="max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700 flex flex-col"
            key={work.title}
          >
            ...
            <div className="p-4 flex flex-col flex-grow">
              ...
              <a
                href={work.url}
                className="mt-auto inline-flex items-center py-2 px-3 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 justify-center"
                target="_blank"
